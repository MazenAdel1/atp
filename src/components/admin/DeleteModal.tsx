      ...
      content={(setIsOpen) => (
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="flex flex-1 items-center justify-center gap-1 rounded-md border-red-600/35 bg-red-600/25 py-2 text-red-600 transition hover:bg-red-600/35 disabled:cursor-not-allowed disabled:opacity-50"
              disabled={isPending}
              onClick={async () => {
                await mutateAsync();
              }}
