    ...
    <Modal
      ...
      content={(setIsOpen) => (
        <div className="flex flex-col gap-4">
          <h2 className="text-center text-xl">حذف الفيديو</h2>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="flex-1 rounded-md border border-red-600/35 bg-red-600/25 py-2 text-red-600 transition hover:bg-red-600/35 disabled:cursor-not-allowed disabled:opacity-50"
