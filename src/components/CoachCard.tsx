...
export default function CoachCard({ img, name, title }: CoachType) {
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-md shadow-lg aspect-[3/4] cursor-pointer group"
    >
      {/* Background Image */}
      <div
      ...
      <div className="absolute w-full bg-gradient-to-t from-black via-black/10 to-transparent h-1/2 bottom-0" />
